...
<title>Vitalia — Ton Plan Bien-être</title>
...
<svg style="display:none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <symbol id="mascot-curcuma" viewBox="0 0 80 80">
      ...
      <!-- Étoiles de sagesse -->
      <text x="34" y="30" font-size="7" fill="#F1C40F">✦</text>
      <text x="41" y="29" font-size="5" fill="#F1C40F">✦</text>
      <!-- Visage sage -->
    ...
    <symbol id="mascot-gingembre" viewBox="0 0 80 80">
      ...
      <text x="62" y="50" font-size="10" fill="#F59E0B">⚡</text>
    </symbol>

    <!-- MYRTILLE - Petit génie antioxydant -->
...
<div class="loading-screen" id="loadingScreen">
  ...
  <div class="loading-text">Vitalia prépare ton plan ✨</div>
...
<div class="config-panel" id="configPanel">
  ...
  <div class="config-title">🌿 Personnalise ton plan</div>

  <div class="config-field">
    <label class="config-label">Comment tu te sens ?</label>
    <div class="config-chips" id="symptomsChips">
      <div class="config-chip selected" onclick="toggleChip(this, 'fatigue')">😴 Fatigue</div>
      <div class="config-chip selected" onclick="toggleChip(this, 'stress')">😰 Stress</div>
      <div class="config-chip" onclick="toggleChip(this, 'digestion')">🌀 Digestion</div>
      <div class="config-chip" onclick="toggleChip(this, 'sommeil')">🌙 Sommeil</div>
      <div class="config-chip" onclick="toggleChip(this, 'inflammation')">🔥 Inflammation</div>
      <div class="config-chip" onclick="toggleChip(this, 'energie')">⚡ Énergie</div>
    </div>
  </div>
  ...
  <div class="config-field">
    <label class="config-label">Régimes alimentaires</label>
    <div class="config-chips">
      <div class="config-chip selected" onclick="toggleChip(this, 'sans_gluten')" data-regime="sans_gluten">🌾 Sans gluten</div>
      <div class="config-chip" onclick="toggleChip(this, 'vegan')" data-regime="vegan">🌱 Végan</div>
      <div class="config-chip" onclick="toggleChip(this, 'sans_lactose')" data-regime="sans_lactose">🥛 Sans lactose</div>
      <div class="config-chip" onclick="toggleChip(this, 'keto')" data-regime="keto">🥑 Kéto</div>
    </div>
  </div>
...
<div class="toast" id="toast"></div>
  ...
  <div class="header">
    ...
    <div class="date-badge" id="dateBadge">Mardi 17 fév.</div>
  </div>
  ...
  <div class="hero">
    <div class="hero-card">
      ...
      <div class="hero-message" id="heroMessage">
        Bonjour ! Prêt à prendre soin de toi ? 🌿
      </div>
  ...
  <div class="companions-section">
    <div class="section-label">Tes alliés du jour</div>
  ...
  <div class="plan-section">
    ...
    <div class="timeline" id="timeline">
        ...
        <div class="moment-header">
          <div class="moment-time-block">
            ...
            <div>
              ...
              <div class="moment-label">Petit-déjeuner</div>
            </div>
          </div>
          <div class="moment-calories" id="matin-cal">350 kcal</div>
        </div>
        <div class="moment-title" id="matin-titre">Bol Énergie Matinale au Curcuma Doré</div>
        <div class="moment-description" id="matin-desc">Un porridge crémeux sans gluten au lait d'amande, généreusement parfumé au curcuma pour un réveil tout en douceur.</div>
        <div class="moment-footer">
          <div class="moment-motivant" id="matin-motivant">Une cuillère d'or pour bien démarrer ! ✨</div>
          <button class="expand-btn" id="btn-matin">▼</button>
        </div>
      ...
      <div class="moment-card midi" onclick="toggleInstructions('midi')">
        <div class="moment-header">
          <div class="moment-time-block">
            <div class="moment-emoji">☀️</div>
            <div>
              <div class="moment-time" id="midi-time">12h30</div>
              <div class="moment-label">Déjeuner</div>
            </div>
          </div>
          <div class="moment-calories" id="midi-cal">550 kcal</div>
        </div>
        <div class="moment-title" id="midi-titre">Bowl Réconfort Lentilles & Potimarron Rôti</div>
        <div class="moment-description" id="midi-desc">Un mélange gourmand de lentilles corail, de potimarron rôti au romarin et d'épinards frais, le tout arrosé d'une vinaigrette citron-gingembre.</div>
        <div class="moment-footer">
          <div class="moment-motivant" id="midi-motivant">Ce bol est une vraie caresse pour tes papilles 💛</div>
          <button class="expand-btn" id="btn-midi">▼</button>
        </div>
      ...
      <div class="moment-card apres-midi" onclick="toggleInstructions('apres_midi')">
        ...
        <div class="moment-title" id="apres_midi-titre">Pause Douceur & Cohérence Cardiaque</div>
        <div class="moment-description" id="apres_midi-desc">Un carré de chocolat noir à 70% accompagné d'une tisane au thym, suivi de 5 minutes de cohérence cardiaque pour recentrer ton énergie.</div>
        <div class="moment-footer">
          <div class="moment-motivant" id="apres_midi-motivant">Prends ce moment rien que pour toi 🙏</div>
          <button class="expand-btn" id="btn-apres_midi">▼</button>
        </div>
      ...
      <div class="moment-card soir" onclick="toggleInstructions('soir')">
        <div class="moment-header">
          <div class="moment-time-block">
            ...
            <div>
              ...
              <div class="moment-label">Dîner</div>
            </div>
          </div>
          <div class="moment-calories" id="soir-cal">450 kcal</div>
        </div>
        <div class="moment-title" id="soir-titre">Velouté Cocon de Patate Douce & Pois Chiches Croquants</div>
        <div class="moment-description" id="soir-desc">Une soupe onctueuse à la patate douce et lait de coco, agrémentée de pois chiches rôtis aux épices pour le croquant.</div>
        <div class="moment-footer">
          <div class="moment-motivant" id="soir-motivant">Un dîner léger et nourrissant pour une nuit réparatrice 🌙</div>
          <button class="expand-btn" id="btn-soir">▼</button>
        </div>
        <div class="moment-instructions" id="instructions-soir">
          <div class="instructions-content" id="soir-instructions">
            ...
            <div class="instructions-tip"><strong>Astuce :</strong> La patate douce est riche en tryptophane, precurseur de la serotonine et de la melatonine — parfaite le soir pour favoriser un endormissement serein. Le lait de coco apporte des triglycerides a chaine moyenne, facilement digeres.</div>
          </div>
        </div>
      </div>
  ...
  <div class="feedback-bar" id="feedbackBar" style="display:none">
    <div>
      ...
      <div style="font-size:11px;color:var(--text-light);margin-top:2px;">Ta note nous aide à améliorer tes prochains plans</div>
    </div>
    <div class="feedback-stars" id="feedbackStars">
      <span class="feedback-star" onclick="noterPlan(1)">⭐</span>
      <span class="feedback-star" onclick="noterPlan(2)">⭐</span>
      <span class="feedback-star" onclick="noterPlan(3)">⭐</span>
      <span class="feedback-star" onclick="noterPlan(4)">⭐</span>
      <span class="feedback-star" onclick="noterPlan(5)">⭐</span>
    </div>
    <span class="feedback-sent" id="feedbackSent">Merci ! 🙏</span>
  </div>

  <!-- ROUTINE DU JOUR -->
  <div class="routine-section">
    <div class="routine-card">
      <div class="routine-title">🧘 Routine du jour</div>
      <div class="routine-items">
        <div class="routine-item">
          <div class="routine-dot"></div>
          <div class="routine-text"><strong>Matin :</strong> <span id="routine-matin">5 minutes de cohérence cardiaque (inspirer 5s, expirer 5s)</span></div>
        </div>
        <div class="routine-item">
          <div class="routine-dot" style="background: var(--terracotta);"></div>
          <div class="routine-text"><strong>Complément phare :</strong> <span id="routine-complement">Vitamine D — 1 goutte ce midi avec ton repas pour soutenir l'immunité</span></div>
        </div>
        <div class="routine-item">
          <div class="routine-dot" style="background: var(--golden);"></div>
          <div class="routine-text"><strong>Aromathérapie :</strong> <span id="routine-aroma">Diffusion lavande le soir pour préparer le sommeil</span></div>
        </div>
        <div class="routine-item">
          <div class="routine-dot" style="background: var(--mirtille-purple);"></div>
          <div class="routine-text"><strong>Soir :</strong> <span id="routine-soir">10 minutes de lecture légère ou d'écoute de musique douce, sans écran</span></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="conseil-section">
    <div class="conseil-card">
      <div class="conseil-title">💡 Le saviez-vous ?</div>
      <div class="conseil-text" id="conseilText">
        Le curcuma et le magnésium (présent dans les légumineuses) sont de précieux alliés contre la fatigue et le stress. Le curcuma aide à moduler l'inflammation, tandis que le magnésium participe à plus de 300 réactions enzymatiques, dont la production d'énergie.
      </div>
    </div>
  </div>
...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB0em15dXVneGhzYnJ5bmp3bGhwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzAwNDY1NjUsImV4cCI6MjA4NTYyMjU2NX0.Pel8am6iplwwFSqolEV7JOG6nxsOx4BxxJPLsObRC-4' // â† à remplacer

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// STATE — chargé depuis le profil
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
let selectedSymptoms = ['fatigue', 'stress']
let selectedRegimes = ['sans_gluten']
let currentPlan = null
let profilUtilisateur = null // profil complet chargé depuis localStorage/Supabase
let currentHistoriqueId = null // ID de l'entrée historique du plan en cours

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// INIT — charger le profil dès le départ
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 1. Récupérer l'ID profil — depuis l'URL (?profil_id=...) ou localStorage
  const urlParams = new URLSearchParams(window.location.search)
  const profilIdUrl = urlParams.get('profil_id')
  const profilIdLocal = localStorage.getItem('vitalia_profil_id')

  // Auth : récupérer le token de session pour les appels Supabase
  const sessionToken = localStorage.getItem('vitalia_access_token')
  if (sessionToken) {
    // Injecter le token dans les headers par défaut
    window._supabaseToken = sessionToken
  }
  const profilId = profilIdUrl || profilIdLocal

  if (profilId && profilId !== 'new') {
    // 2. Charger d'abord depuis localStorage (instantané)
    ...
    if (profilLocal) {
      try {
        ...
        console.log('✅ Profil chargé depuis localStorage:', profilId)
      } catch(e) {}
    }

    // 3. Rafraîchir depuis Supabase en arrière-plan
    chargerProfilSupabase(profilId)
  }

  afficherEtoiles(8)

  // Afficher le widget feedback après que le contenu statique soit visible (demo/prototype)
  setTimeout(() => {
  ...
  if (profilId && profilId !== 'new') {
    // Profil trouvé → générer le plan automatiquement
    setTimeout(() => genererPlan(), 500)
  } else {
    // Aucun profil → rediriger vers l'onboarding
    setTimeout(() => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data && data[0]) {
        ...
        console.log('✅ Profil rafraîchi depuis Supabase')
      }
    }
  } catch(e) {
    console.log('Profil chargé depuis localStorage uniquement')
  }
}
...
function appliquerProfil(p) {
  ...
  // Pré-remplir les symptômes depuis les objectifs du profil
  ...
  if (p.prenom) {
    document.getElementById('heroMessage').textContent =
      `Bonjour ${p.prenom} ! Prêt à prendre soin de toi ? 🌿`
  }
}

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// GÉNÉRER UN PLAN — flux complet N1→N2→N3
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
async function genererPlan() {
  ...
  // Récupérer l'ID profil (URL > localStorage > fallback prototype)
  const urlParams = new URLSearchParams(window.location.search)
  ...
  try {
    ...
    // ── NIVEAU 1 & 2 : si on a un vrai profil Supabase ──
    if (profilId && profilId !== 'new') {
      try {
        ...
        if (reponseN12.ok) {
          ...
          if (dataN12.ingredients_selectionnes) {
            ...
            console.log('✅ N1+N2 : ingrédients filtrés depuis profil réel')
          }
        }
      } catch(e) {
        console.log('ℹï¸ N1+N2 indisponible, fallback ingrédients locaux')
      }
    }

    // Fallback : construire les ingrédients localement avec rotation
    if (!ingredientsSelectionnes) {
      ingredientsSelectionnes = construireIngredients(selectedSymptoms)
      // Mélanger chaque catégorie pour varier même sans N1+N2
      ...
      console.log('ℹï¸ Ingrédients construits localement (avec rotation)')
    }
    ...
    // Appel N3 : generer-plan gère tout en interne (N1+N2+LLM)
    // On envoie uniquement ce que la fonction attend
    const bodyN3 = {
      profil_id: profilId,  // null si pas de profil → N3 utilisera fallback
      symptomes: selectedSymptoms,
      preferences_moment: { temps_max: tempsMax, budget_max: budgetMax },
      force_regeneration: true
    }

    // Si pas de profil Supabase, injecter les ingrédients locaux directement
    if (!profilId || profilId === 'new') {
      bodyN3.ingredients_override = ingredientsSelectionnes
      bodyN3.profil_override = profilSecurite
    }

    const reponseN3 = await fetch(
      `${SUPABASE_URL}/functions/v1/generer-plan`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        ...
        body: JSON.stringify(bodyN3)
      }
    )

    if (!reponseN3.ok) {
      const errTxt = await reponseN3.text()
      console.error('Erreur HTTP N3:', reponseN3.status, errTxt)
      throw new Error('Erreur serveur ' + reponseN3.status)
    }

    const dataN3 = await reponseN3.json()
    console.log('Réponse N3:', JSON.stringify(dataN3).substring(0, 200))

    if (dataN3.success && dataN3.plan) {
      afficherPlan(dataN3.plan)
    } else {
      console.error('Réponse API N3 complète:', dataN3)
      throw new Error(dataN3.error || dataN3.details || 'Plan invalide reçu')
    }
...
function afficherPlan(plan) {
  ...
  // Hero
  document.getElementById('heroMessage').textContent = plan.message_personnalise || 'Ton plan est prêt ! 🌿'
  ...
  const emojis = { matin: '🌅', midi: '☀️', apres_midi: '🍃', soir: '🌙' }
  ...
  moments.forEach(moment => {
    ...
    setText(moment + '-cal', (data.calories_estimees || '—') + ' kcal')
...
function renderInstructions(moment, data) {
  var el = document.getElementById(moment + '-instructions')
  if (!el) return

  // Cas 1 : objet structure {ingredients, steps, tip} (plans statiques)
  if (data && typeof data === 'object' && !Array.isArray(data) && data.steps) {
    var ingHtml = ''
    if (data.ingredients && data.ingredients.length) {
      ingHtml = '<div class="instructions-section-label">Ingredients</div>' +
        '<div class="instructions-ingredients">' +
        data.ingredients.map(function(i) {
          return '<span class="ingredient-tag">' + i + '</span>'
        }).join('') + '</div>'
    }
    var stepsHtml = '<div class="instructions-section-label">Preparation</div>' +
      '<div class="instructions-steps">' +
      data.steps.map(function(step, n) {
        return '<div class="instruction-step"><div class="step-num">' + (n+1) +
          '</div><div class="step-text">' + step + '</div></div>'
      }).join('') + '</div>'
    var tipHtml = data.tip
      ? '<div class="instructions-tip"><strong>Astuce :</strong> ' + data.tip + '</div>'
      : ''
    el.innerHTML = ingHtml + stepsHtml + tipHtml
    return
  }

  // Cas 2 : string venant du LLM - on la decoupe en etapes numerotees
  if (typeof data === 'string' && data.trim()) {
    var text = data.trim()

    // Decouper par newline ou par phrase (". ")
    var rawLines
    if (text.indexOf('\n') >= 0) {
      rawLines = text.split('\n')
    } else {
      // Split sur ". " : reconstitue chaque phrase avec son point
      var parts = text.split('. ')
      rawLines = parts.map(function(s, i) {
        return (i < parts.length - 1) ? s + '.' : s
      })
    }

    // Nettoyer et filtrer les fragments trop courts
    var steps = rawLines
      .map(function(l) { return l.replace(/^\d+[.)]\s*/, '').trim() })
      .filter(function(l) { return l.length > 10 })

    if (steps.length >= 2) {
      el.innerHTML = '<div class="instructions-section-label">Preparation</div>' +
        '<div class="instructions-steps">' +
        steps.map(function(step, n) {
      ...
      el.innerHTML = '<div class="instructions-section-label">Preparation</div>' +
        '<div class="instructions-steps"><div class="instruction-step">' +
        '<div class="step-num">1</div><div class="step-text">' + text + '</div>' +
        '</div></div>'
    }
    return
  }
  ...
  // Cas 3 : fallback
  if (data) el.textContent = String(data)
}
 ...
 * Retourne l'UUID de la ligne créée (pour le feedback ensuite)
 */
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data && data[0]) {
        ...
        console.log('✅ Plan logué dans historique:', currentHistoriqueId)
      }
    }
  } catch(e) {
    console.log('ℹï¸ Log historique non disponible (offline?)')
  }
}

/**
 * Extraire tous les IDs produits mentionnés dans le plan
 */
...
async function noterPlan(note) {
  ...
  // Masquer les étoiles, afficher "Merci"
  setTimeout(() => {
  ...
  // Toast
  afficherToast(note >= 4 ? '🎉 Super ! On ameliore tes prochains plans !' : note >= 3 ? '👍 Note ! On diversifie la suite' : '🔄 Compris ! Plan plus varie demain')
  ...
  if (currentHistoriqueId) {
    try {
      ...
      console.log('✅ Feedback', note, '★ sauvegardé')
    } catch(e) {
      console.log('ℹï¸ Feedback sauvegardé localement uniquement')
    }
  }
...
function afficherEtoiles(score) {
  ...
  let html = ''
  for (let i = 0; i < plein; i++) html += '<span class="star">⭐</span>'
  if (demi) html += '<span class="star">✨</span>'
...
// Construit une sélection d'ingrédients adaptée aux symptômes choisis
// (simule le travail des Niveaux 1 & 2 pour le prototype)
function construireIngredients(symptomes) {
  // Pool complet — on pioche aléatoirement dedans
  const pool = {
    proteines: shuffleArray([
      ...
      { id: 'ALI_014', nom: 'Å’ufs', type_produit: 'ALI', score_final: 8 },
    ...
    legumes: shuffleArray([
      { id: 'ALI_005', nom: 'Épinards', type_produit: 'ALI', score_final: 8 },
    ...
    complements: shuffleArray([
      ...
      { id: 'NUT_007', nom: 'Oméga-3', type_produit: 'NUT', score_final: 9 }
    ]),
    routines: shuffleArray([
      { id: 'ROU_001', nom: 'Cohérence cardiaque', type_produit: 'ROU', score_final: 8 },
      { id: 'ROU_002', nom: 'Méditation guidée', type_produit: 'ROU', score_final: 8 },
  ...
  // Sélectionner un sous-ensemble aléatoire du pool
  const base = {
  ...
  // Ajuster selon symptômes
  if (symptomes.includes('fatigue') || symptomes.includes('energie')) {
    base.complements.push({ id: 'NUT_003', nom: 'Magnésium', type_produit: 'NUT', score_final: 9 })
  ...
  if (symptomes.includes('stress')) {
    ...
    base.routines.push({ id: 'ROU_002', nom: 'Méditation guidée', type_produit: 'ROU', score_final: 8 })
  }

  if (symptomes.includes('sommeil')) {
    base.complements.push({ id: 'NUT_013', nom: 'Mélatonine', type_produit: 'NUT', score_final: 7 })
    base.complements.push({ id: 'NUT_012', nom: 'L-théanine', type_produit: 'NUT', score_final: 8 })
  ...
  if (symptomes.includes('inflammation')) {
    ...
    base.complements.push({ id: 'NUT_007', nom: 'Oméga-3', type_produit: 'NUT', score_final: 9 })
  }
